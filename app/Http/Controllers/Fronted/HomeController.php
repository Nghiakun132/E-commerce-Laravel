    ...
    public function update_password(Request $request)
    {
        ...
        $this->validate(
            ...
            [
                ...
                'old_password.max' => 'Mật khẩu cũ không được vượt quá 32 ký tự',
        ...
        if ($user) {
            ...
            DB::table('users')->where('id', $user_id)->update($data);
            return redirect()->back()->with('pw_success', 'Đổi mật khẩu thành công');
        } else {
            return redirect()->back()->with('pw_error', 'Mật khẩu cũ không đúng');
        }
    }
