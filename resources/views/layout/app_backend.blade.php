...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-secondary bg-success">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{route('get_backend.home')}}"><img src="{{asset('public/img/2.png')}}" alt=""></a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{URL::to('admin/change-info',$user)}}">Thay đổi thông tin</a></li>
                        {{-- <li><a class="dropdown-item" href="#!">Activity Log</a></li> --}}
                        <li><hr class="dropdown-divider" /></li>
                        <li><a class="dropdown-item" href="{{route('get_backend.logout')}}">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
