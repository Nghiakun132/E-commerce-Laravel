...
<body class="">
    <div class="wrapper ">
        <div class="sidebar" data-color="black" data-background-color="white" data-image="{{asset('././public/test/img/sidebar-4.jpg')}}">
          <div class="logo"><a href="{{route('get_backend.home')}}" class="simple-text logo-normal">
              <img src="{{asset('././public/img/2.png')}}" alt="">
            </a></div>
              ...
              <div class="collapse navbar-collapse justify-content-end">
                ...
                <ul class="navbar-nav">
                  ...
                  <?php
                            ...
                            ?>
                  <li class="nav-item dropdown">
                    <a class="nav-link vc" href="javascript:;" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                      <a class="dropdown-item" href="{{URL::to('admin/change-info',$id)}}">Thông tin</a>
